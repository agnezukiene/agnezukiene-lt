...
for (const pattern of [".env", "*.local", "*-oauth-token.json", ".dev.vars", "Agnes foto/", "drafts/", "tmp/"]) {
...
for (const requiredCookieText of ["agne_cookie_choice", "agne_cookie_reset_pending", "_ga", "iki 2 metų", "Apsaugos kodas įkeliamas tik pradėjus pildyti kontaktų formą", "vienkartinį patvirtinimą"]) {
