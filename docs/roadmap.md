...
- `[x]` 2026-09-10 pašalintas pradinis telefono meniu persitvarkymas: lėtesnio ryšio matavime pagrindinis turinys pasirodė maždaug per 0,86 sekundės, o turinio šoktelėjimo rodiklis sumažėjo nuo `0,287` iki `0`. Ankstyvas meniu ženklas leidžiamas tik tiksliu saugumo kontroliniu kodu; išjungus papildomą naršyklės kodą visos penkios nuorodos lieka matomos ir nėra šoninio slinkimo.
...
- `[x]` 2026-09-11 sprendimo autoriaus įrašas „Sukurta D2.lt“ papildytas ir klaidos puslapyje. Dabar jis nuosekliai rodomas visuose devyniuose svetainės puslapiuose, o vietinė ir gyvos svetainės patikra saugo saugią nuorodą bei jos atidarymą naujame skirtuke.
...
- `[~]` 2026-09-11 visų trijų pirmųjų temų pilni juodraščiai parengti tik vietiniame `drafts/` aplanke: apie kreipimąsi į psichologą dar iki krizės, pasiruošimą pirmajam pokalbiui ir pokalbį su vaiku apie jausmus. Aplankas apsaugotas nuo patekimo į viešą „GitHub“, o automatinė projekto saugumo patikra neleistų jo įkelti net per klaidą. Visiems tekstams dar būtinas Agnės profesinių formuluočių ir viešinimo patvirtinimas.
