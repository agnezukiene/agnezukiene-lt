...
- `[~]` 2026-07-21 visuose puslapiuose pažymėta dabartinė lankytojo vieta, kad ją aiškiai praneštų ekrano skaitymo priemonė. Reikalavimas įtrauktas į vietinę ir gyvos svetainės patikrą; laukia naršyklės ir gyvos svetainės patvirtinimas.
