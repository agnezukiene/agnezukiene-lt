...
- `[~]` 2026-07-21 kontaktų puslapis padarytas atsparus papildomo svetainės kodo sutrikimui: neveikiant formai jos laukai ir siuntimo mygtukas nerodomi, o vietoje jų pateikiamas aiškus tiesioginis el. pašto adresas. Vietinė telefono ir kompiuterio patikra praėjo, laukia gyva patikra.
